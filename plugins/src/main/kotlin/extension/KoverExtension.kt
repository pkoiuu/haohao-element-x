...
fun Project.setupKover() {
    // HaohaoChat: 个人构建禁用 Kover 代码覆盖率，减少字节码 instrumentation 开销
    // 通过 -PdisableKover=true 或 gradle.properties 中的 disableKover=true 控制
    if (project.hasProperty("disableKover")) {
        return
    }
